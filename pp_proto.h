...
PERL_CALLCONV INSTRUCTION *Perl_pp_instr_cond_jump(pTHX);
PERL_CALLCONV INSTRUCTION *Perl_pp_instr_const_list(pTHX);
PERL_CALLCONV INSTRUCTION *Perl_pp_instr_end(pTHX);
PERL_CALLCONV INSTRUCTION *Perl_pp_instr_jump(pTHX);
